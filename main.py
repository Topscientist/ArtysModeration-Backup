...
banned_words = [
    ...
    "f@GG", "FaGG", "fAGG", "F@gG", "f@gg", "F@GG", "sHiT"
]
        ...
        if any(word in msg for word in sad_words):
            ...
            if author != owner:
                ...
                if guild_id in db:
                    ...
                    print(
                        "Guild Config> cheer up configuration for a guild attempted to update"
                    )
                else:
                    ...
                    print(
                        "Guild Config> cheer up configuration for a guild has been updated"
                    )
            ...
            if author != owner:
                ...
                if str(name) in db:
                    ...
                    print(
                        "Guild Config> moderation configuration for a guild attempted to update"
                    )
                else:
                    db[name] = "True"
                    await message.channel.send(
                    ...
                    print(
                        "Guild Config> moderation configuration for a guild has been updated"
                    )
            ...
            await message.channel.send(embed=embed)
            print("Command> arty labs has been executed")
            ...
            if name == 'EXAMPLE-HERE123':
                ...
                embed.add_field(name=f"💭 Inspiration and Quotes:",
                                ...
                                inline=False)
                embed.add_field(
                    name=f"🌐 The GitHub page for Artys Moderation:",
                    value="arty github",
                    inline=False)
            ...
            embed = discord.Embed(
                title='Bot Status - BACKUP BOT',
                description=
                "**Backup Bot** The main bot is currently being cloudflare rate limited and sadly there nothing I can do about it. Please join our support discord for more informtaion.",
                color=discord.Colour.red())
            await message.channel.send(embed=embed)
            print('Command> arty status has been executed')
            ...
            print('Command> arty discord has been executed')
            ...
            await message.channel.send(embed=embed)
            print("Command> arty report help was executed")
            ...
            if any(word in msg for word in report_required):
                ...
                if any(word in msg for word in banned_entries):
                    ...
                    embed = discord.Embed(
                        title='💥 Error',
                        description=
                        'I cannot report myself, If I am misbehaving please type `arty discord` and contact my dev team. They would love to help out!',
                        color=discord.Colour.red())
                    await message.channel.send(embed=embed)
                    return
                ...
                embed = discord.Embed(
                    title='💥 Error',
                    description=
                    'You need to @mention a valid user in your report',
                    color=discord.Colour.red())
                await message.channel.send(embed=embed)
...
while escape == "ok":
  try:
    if escape == "ok":
      ...
      response_code = (urllib.request.urlopen("https://artys-moderation.topscientist.repl.co/", timeout=timeout).getcode())
